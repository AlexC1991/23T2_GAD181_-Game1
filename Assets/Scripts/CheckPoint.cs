...
namespace AlexzanderCowell
{
    ...
    {
        [HideInInspector]
        private bool newSavePoint; // This bool detects when a player goes through the collider and sets off a true to allow the event to send off to the character movement that its okay to save here.
