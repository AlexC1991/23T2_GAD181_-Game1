...
namespace AlexzanderCowell
{
    public class RocketBootController : MonoBehaviour
    {
        ...
        [SerializeField] private Transform footLeft; // This is the left foot of the character for the placement of the left rocket boot/shoe.
        [SerializeField] private Transform footRight; // This is the right foot of the character for the placement of the right rocket boot/shoe.
        ...
        {
            if (rocketBootState && currentBootTimer > 0.2f)
            {   
