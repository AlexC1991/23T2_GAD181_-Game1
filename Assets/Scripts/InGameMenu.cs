...
namespace AlexzanderCowell
{
    public class InGameMenu : MonoBehaviour
    {
        ...
        private bool menuDuringGame;

        private void OnEnable()
        {
            CharacterMovement._UsingInGameMenuEvent += InMainGameNow;
        }
        ...
        {
            Time.timeScale = 0;
            menuDuringGame = true; // Sets the in game menu to not show due to a false bool.
        ...
        {
            if (canUseInGameMenu) menuDuringGame = true;
        }
